...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Tg3dMobileScanSDK-iOS/Tg3dMobileScanSDK_iOS.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ZIPFoundation/ZIPFoundation.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/I3DRecorder/I3DRecorder.framework"
fi
